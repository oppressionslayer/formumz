...
**Started:** 2026-05-22
**Goal:** This is a project i'm going to be working on for cancer research and plan to provide results here soon. To help you can run the WSRF library family against public Kaggle datasets for bone marrow cancers (multiple myeloma, leukemias) and document any result — better, same, or worse than published baselines. Publishable findings get written up; null results get logged honestly so we don't repeat them.
